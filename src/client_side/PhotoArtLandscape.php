...
<h1>Landscape - <span id="ital"> Wider angles makes your mouth dangle</span></h1>
<?php
$sql = ("SELECT title, imageLink, upc, category, description FROM Product WHERE category='Landscape'");
